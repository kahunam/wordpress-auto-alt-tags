 ...
 * Description: Automatically generates alt tags for images using AI APIs. Features auto-generation on upload, background processing via WP Cron, Media Library integration (column, filter, per-image regenerate), CSV import/export, and WP-CLI support.
 * Version: 1.1.0
 * Author: Kahunam
